            ...
            <div class="col-md-6 offset-md-3">
                ...
                <div class="card my-5">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="card-body cardbody-color p-lg-5">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success px-5 mb-5 w-100">Ingresar</button>
                        </div>
                        <div class="form-text text-center mb-5 text-dark">No estas registrado? 
                            <a type="submit" href="{{ route('register') }}" class="text-dark fw-bold"> Crear cuenta</a>
                        </div>
                    </form>
                </div>
            </div>
